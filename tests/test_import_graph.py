...
def test_demo_repo_import_graph():
  ...
  print(f"Yes Found {len(edges)} total import edges")
  print(f"Yes Found {len(python_edges)} Python imports")
  print(f"Yes Found {len(ts_edges)} TypeScript imports")
  print("Yes All expected edges present")
...
def test_import_graph_excludes_external_packages():
  ...
  print("Yes No external packages in graph")
